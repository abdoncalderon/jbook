    ...
    <section class="content">
        ...
        <div>
            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('periods.update', $period) }}">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="box-body">
                        ...
                        <input id="id" hidden name="id" value="{{ $period->id }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="start" class="form-control" name="start" type="time" value="{{ $period->start }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="finish" class="form-control" name="finish" type="time" value="{{ $period->finish }}" required>
                            </div>
                        </div>
                    ...
                    <div class="box-footer">
                        ...
                        <a class="btn btn-info btn-sm" href=" {{ route('periods.index') }} ">{{ __('content.cancel') }}</a>
                    </div>
